...
public class CritRateEnchantment extends Enchantment {
    ...
    public CritRateEnchantment() {
        super(Configuration.setRarity(Configuration.RATE_RARITY), EnchantmentTarget.WEAPON, new EquipmentSlot[]{EquipmentSlot.MAINHAND, EquipmentSlot.OFFHAND});
    }
    ...
    public int getMaxLevel() {
        return Configuration.RATE_MAXLEVEL;
    }
}